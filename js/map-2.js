function initialize() {
    ...
    data_lat = jQuery('#map-2').attr('data-latitude');
    data_lng = jQuery('#map-2').attr('data-longitude');
    data_zoom = jQuery('#map-2').attr('data-zoom');
    data_marker = jQuery('#map-2').attr('data-marker');
